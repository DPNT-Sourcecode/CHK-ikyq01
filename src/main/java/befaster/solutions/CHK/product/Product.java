...
import befaster.solutions.CHK.offer.FreeProductsOffer;
...
public class Product implements Comparable<Product> {
	...
	protected Product(int basePrice, int numberOfChargedProducts, char freeProductCode) {
		this(basePrice, null, null, null);
		this.freeProductsOffers.add(new FreeProductsOffer(numberOfChargedProducts, 1, freeProductCode));
	}
	...
	public List<FreeProductsOffer> getFreeProductsOffers() {
		return freeProductsOffers;
	}
